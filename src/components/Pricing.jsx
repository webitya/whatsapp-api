...
const Pricing = () => {
    ...
    return (
        <section id="pricing" className="py-32 relative overflow-hidden bg-zinc-950">
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-purple-500/5 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-brand-green/5 blur-[120px] rounded-full pointer-events-none" />

            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-20">
                    <h2 className="text-5xl font-bold mb-6">Simple Pricing. <span className="text-gray-500">No Surprises.</span></h2>
                    <p className="text-gray-400 text-lg mb-10">Pay only for what you use. Zero hidden fees.</p>
                ...
                <div className="flex flex-col lg:flex-row gap-8 justify-center items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="w-full max-w-md p-10 rounded-[2.5rem] bg-zinc-900/50 border border-zinc-800 hover:border-brand-green/50 transition-all duration-300 relative group overflow-hidden"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <Link href="#book-demo" className="block">
                                <MagneticButton className="w-full py-4 rounded-xl bg-white text-black font-bold flex items-center justify-center gap-2 hover:bg-brand-green hover:text-white transition-all duration-300 shadow-lg">
                                    Get Started Now
                                </MagneticButton>
                            </Link>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="w-full max-w-md p-10 rounded-[2.5rem] bg-zinc-950 border border-zinc-800 relative overflow-hidden"
                    >
                        ...
                        <Link href="#book-demo" className="block">
                            <MagneticButton className="w-full py-4 rounded-xl border border-white/10 text-white font-bold flex items-center justify-center gap-2 hover:bg-white hover:text-black transition-all duration-300">
